...
class SEGNN(nn.Module):
    ...
    sphharm_norm: str = (
        "component"  # Normalization for spherical harmonics; "component", "integral", "norm"
    )
    irreps_out: Optional[Irreps] = (
    ...
    intermediate_hidden_irreps: bool = (
        False  # Use hidden irreps for intermediate message passing steps; otherwise use input irreps
    )
