...
def run_expt(
    ...
    halo_test, y_test = next(val_iter)
    ...
    halo_val, y_val, tpcfs_val = split_batches(num_local_devices, halo_val, y_val, tpcfs_val)
    halo_test, y_test, tpcfs_test = split_batches(num_local_devices, halo_test, y_test, tpcfs_test)
