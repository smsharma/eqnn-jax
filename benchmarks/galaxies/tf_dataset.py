...
MEAN_HALOS_DICT = {'x': 499.91877075908684, 
                   'y': 500.0947802559321,  
                   'z': 499.964508664328,
                   'Jx': 212560050888254.06,
                   'Jy': 349712732356652.25, 
                   'Jz': -100259775332585.12, 
                   'vx': -0.0512854365234889, 
                   'vy': -0.01263126442198149, 
                   'vz': -0.06458034372345466, 
                   'M200c': 321308383763206.9, 
                   'Rvir': 1424.4071655758826}

STD_HALOS_DICT = {'x': 288.71092533309235, 
                  'y': 288.7525818573022, 
                  'z': 288.70234893905575, 
                  'Jx': 2.4294356933448945e+18, 
                  'Jy': 2.3490019110577966e+18, 
                  'Jz': 2.406422979830857e+18, 
                  'vx': 344.0231468131901, 
                  'vy': 343.9333673335964, 
                  'vz': 344.071876710777, 
                  'M200c': 405180433634974.75, 
                  'Rvir': 298.14502916425675}

MEAN_PARAMS_DICT = {'Omega_m': 0.29994175, 
                    'Omega_b': 0.049990308, 
                    'h': 0.69996387, 
                    'n_s': 0.9999161, 
                    'sigma_8': 0.7999111}

STD_PARAMS_DICT = {'Omega_m': 0.11547888, 
                   'Omega_b': 0.017312417, 
                   'h': 0.11543678, 
                   'n_s': 0.115482554, 
                   'sigma_8': 0.11545073}
